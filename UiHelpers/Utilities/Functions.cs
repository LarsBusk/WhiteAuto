...
namespace Common.Utilities
{
    public class Functions
    {
        ...
        public Functions(Uis appToRun)
        {
            ...
            switch (appToRun)
            {
                case Uis.MeatMaster2:
                    this.MainWindow = ApplicationHelpers.GetMainWindow(MeatMaster2UiItems.Mm2ProcessName,
                        MeatMaster2UiItems.Mm2MainWindowName);
                ...
                case Uis.pNova:
                    this.MainWindow =
                        ApplicationHelpers.GetMainWindow(UiItems.ProFossProcessName, UiItems.PnovaMainWindowName);
                    this.StartStopButton = UiItems.PnovaStartStopButton;
                    break;
                case Uis.Advanced:
                    this.MainWindow =
                        ApplicationHelpers.GetMainWindow(UiItems.AdvancedUiProcessName, UiItems.BenchMainWindowName);
                ...
                case Uis.Metrohm:
                    this.MainWindow =
                        ApplicationHelpers.GetMainWindow(UiItems.MetrohmProcessName, UiItems.BenchMainWindowName);
                    this.StartStopButton = UiItems.AdvancedUiStartStopButton;
                    this.SelectProductsDialogName = UiItems.AdvancedSelectProductDialogName;
                    this.ProductList = UiItems.AdvancedProductsList;
                    this.SelectProductDialogIsUpdated = true;
                ...
                case Uis.Mini:
                    this.MainWindow =
                        ApplicationHelpers.GetMainWindow(UiItems.MiniUiProcessName, UiItems.BenchMainWindowName);
                ...
                case Uis.Matilde:
                    this.MainWindow =
                        ApplicationHelpers.GetMainWindow(UiItems.MatildeProcessName, UiItems.PnovaMainWindowName);
                    break;
                default:
                    break;
            }
        ...
        public void HandleSampleRegistration()
        {
            ...
            {
                Button okButton = MainWindow.ModalWindow("UdfDialog")
                    .Get<Button>(SearchCriteria.ByText("PopupLeftButton"));
        ...
        public void WaitForSample(int timeBetweenSamples)
        {
            ...
            WaitHelpers.WaitForEnabled(selectProductButton, TimeSpan.FromMinutes(5),
                TimeSpan.FromSeconds(timeBetweenSamples));
        ...
        public void CloseDown()
        {
            ...
            MainWindow.ModalWindow(MeatMaster2UiItems.MessageBoxPopup)
                .Get<Button>(SearchCriteria.ByText(MeatMaster2UiItems.PopupLeftButton)).Click();
        }
        ...
        public void SelectInstrument(string serialNumber)
        {
            ...
            try
            {
                ...
                ListItem itemToSelect =
                    selectInstrumentComboBox.Items.FirstOrDefault(i => i.Name.StartsWith(serialNumber));
                itemToSelect.Select();
            }
            catch (Exception e)
            {
        ...
        public void SelectAndStartTest(string test)
        {
            var advancedDiagnosticsDialogPopup = SelectTest(test);
            ClickButton(UiItems.RunTestButton, advancedDiagnosticsDialogPopup);
            WaitHelpers.SafeWaitFor(() => advancedDiagnosticsDialogPopup.Get<Button>(UiItems.OkButton).Enabled,
                TimeSpan.FromMinutes(5), TimeSpan.FromSeconds(5));
            ClickButton(UiItems.OkButton, advancedDiagnosticsDialogPopup);
            ClickButton(UiItems.CloseButton, advancedDiagnosticsDialogPopup);
        }

        public void SelectAndRunAllTests()
        {
            var advancedDiagnosticsDialogPopup = SelectTest("All tests");
            ClickButton(UiItems.RunTestsButton, advancedDiagnosticsDialogPopup);
            WaitHelpers.SafeWaitFor(
                () => advancedDiagnosticsDialogPopup.Get<Button>(UiItems.CloseButton).Enabled,
        ...
        private Window SelectTest(string test)
        {
            ClickButton(UiItems.AdvancedDiagnosticsButton);
            var advancedDiagnosticsDialogPopup = MainWindow.ModalWindow(UiItems.AdvancedDiagnosticsDialogPopup);
            logger.LogInfo($"Window found {advancedDiagnosticsDialogPopup.Name}");
            var testList = advancedDiagnosticsDialogPopup.Get<ListBox>(UiItems.ModuleTestsListView);
            var items = testList.Items;
            var testItem = items.FirstOrDefault(i => i.Text.Equals(test));
            logger.LogInfo($"Found {testItem.Text}");
            testItem.Click();
            return advancedDiagnosticsDialogPopup;
        }
